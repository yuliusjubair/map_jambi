    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Tambah Kecamatan</h3>
                ...
                <form action="#" id="form_modal_popup" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-labelxx col-sm-6">Nama Kecamatan<span style="color:red">*</span></label>
                            <div class="col-sm-12">
                                <input id="nama" name="nama" placeholder="Nama Kecamatan" class="form-control" type="text" required>
