...
<body>
   ...
   <div class="col-md-8">
    ...
    <h5 class="modal-title" id="exampleModalLabel">Edit Data Location</h5>
      <form action="<?php echo base_url()?>home/update_data" method="POST" id="form_modal" class="form-horizontal">
...
<script src="<?=base_url()?>assets/vendor/jquery/jquery.min.js"></script>
    ...
    $(document).ready(function() {
     ...
     var endPointLocation = new L.LatLng(<?php echo $row->waypoint1?>);
   ...
   /* var map4 = new L.Map('map4', {
    ...
    var b = new L.LatLng(<?php echo $row->waypoint2?>);
    ...
    var data = [
      [
        [<?php echo $row->waypoint1?>],[<?php echo $row->waypoint2?>]
      ]
  ];
// console.log(data);
